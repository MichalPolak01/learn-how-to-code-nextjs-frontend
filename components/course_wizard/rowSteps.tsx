  ...
  (
    ...
    return (
      <nav aria-label="Progress" className="-my-4 max-w-fit overflow-x-auto py-4">
        <ol className={cn("flex lg:flex-row flex-col flex-nowrap gap-x-3", colors, className)}>
              ...
              <li key={stepIdx} className="relative flex w-full items-center pr-12">
                ...
                >
                  ...
                  {stepIdx < steps.length - 1 && !hideProgressBars && (
                    <div
                      aria-hidden="true"
                      className="pointer-events-none absolute right-0 w-10 flex-none lg:visible invisible items-center"
                      style={{
                        // @ts-ignore
                        "--idx": stepIdx,
                      }}
