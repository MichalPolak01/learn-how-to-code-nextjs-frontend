                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap flex-col sm:flex-row gap-4 mt-2">
                      {lesson.introduction && (
                        <Card className={`sm:w-[10rem] h-[5rem] hover:scale-110 ${introductionCompleted? "bg-success-300 border-success-700" : "border-warning-600 bg-warning-50"} border-2`}>
                        <Link className=" text-default-900 flex flex-col justify-center items-center h-full cursor-pointer" 
                          ...
                          {/* <Chip className="italic font-serif text-xs p-1 mb-2" color="primary" size="sm" variant="shadow"> */}
                          <Chip
      className="italic font-serif text-xs p-1 absolute top-1 right-1"
      color="primary"
      size="sm"
      variant="shadow"
    >
                            {introductionCompleted? "Ukończono": ""} 
                          </Chip>
                          <ScrollText />
                          ...
                          <>
                          <div className="border-b-2 border-default-400 w-[8rem] my-2" />
                          <Chip className="w-full italic font-serif text-xs p-1" color="primary" size="sm" variant="shadow">
                            {introductionCompleted? "Ukończono": ""} 
                          </Chip>
                          </>
                          } */}
